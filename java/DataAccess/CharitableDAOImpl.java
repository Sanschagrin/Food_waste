...
public class CharitableDAOImpl implements CharitableDAO {
    ...
    private static final String all = "SELECT * FROM CharitableOrganizations";
    private static final String byID = "SELECT * FROM CharitableOrganizations WHERE charitable_id = ?";
    private static final String insert = "INSERT INTO CharitableOrganizations (charitable_name, charitable_email, charitable_password, charitable_description) VALUES (?, ?, ?, ?)";
    private static final String update = "UPDATE CharitableOrganizations SET charitable_name = ?, charitable_email = ?, charitable_password = ?, charitable_description = ? WHERE charitable_id = ?";
    private static final String delete = "DELETE FROM CharitableOrganizations WHERE charitable_id = ?";
    private static final String QUERY = "SELECT * FROM charitable_organizations WHERE username = ? AND password = ?";
